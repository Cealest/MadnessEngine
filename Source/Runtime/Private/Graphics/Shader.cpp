...
FShader::FShader(const FShader &Other)
{
...
bool FShader::Initialize(ID3D11Device* InDevice, HWND InWindowHandle)
{
	return InitializeShader(InDevice, InWindowHandle, VertexShaderFile, PixelShaderFile);
}

void FShader::Shutdown()
{
	ShutdownShader();
}

bool FShader::Render(ID3D11DeviceContext* InDeviceContext, int InIndexCount, D3DXMATRIX InWorldMatrix, D3DXMATRIX InViewMatrix, D3DXMATRIX InProjectionMatrix)
{
...
bool FShader::InitializeShader(ID3D11Device* InDevice, HWND InWindowHandle, WCHAR* InVertexShaderFile, WCHAR* InPixelShaderFile)
{
	HRESULT result;
...
void FShader::OutputShaderErrorMessage(ID3D10Blob* InErrorMessage, HWND InWindowHandle, WCHAR* InShaderFilename)
{
	char* compileErrors;
	unsigned long i;
	SIZE_T bufferSize;
...
bool FShader::SetShaderParameters(ID3D11DeviceContext* InDeviceContext, D3DXMATRIX InWorldMatrix, D3DXMATRIX InViewMatrix, D3DXMATRIX InProjectionMatrix)
{
	HRESULT result;
...
void FShader::RenderShader(ID3D11DeviceContext* InDeviceContext, int InIndexCount)
{
